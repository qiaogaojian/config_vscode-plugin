...
class TerminalSnippModel {
    ...
    get roots() {
        var _a, _b;
        const snipps = (_b = (_a = this.context) === null || _a === void 0 ? void 0 : _a.globalState) === null || _b === void 0 ? void 0 : _b.get("terminal_snipps", []);
...
class TerminalSnippExplorer {
    constructor(context) {
        ...
        vscode.commands.registerCommand("terminalSnipps.editEntry", (snipp) => {
            ...
            panel.webview.html = edit_terminal_snipp_1.default(snipp);
