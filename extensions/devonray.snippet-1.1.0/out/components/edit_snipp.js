...
function editSnippWebviewContent(snipp) {
    return `<!DOCTYPE html />
  <html lang="en">
    <head>
      <meta charset="UTF-8" />
    ...
    <body>
      ...
      <label>Name</label>
        ...
        <input type="text" value="${snipp.tags.reduce((curr, next) => `${curr} ${curr !== "" ? "+" : ""} ${next}`, "")}" placeholder="Enter Tags separated by +" name="tags">
...
exports.default = editSnippWebviewContent;
//# sourceMappingURL=edit_snipp.js.map