...
class ResourceTreeViewProvider {
    ...
    constructor(collapsed) {
        this.items.push(this.buildSubtree("Isaac Sim", this.parseJSON("isaacsim.json"), collapsed));
        this.items.push(this.buildSubtree("Isaac Lab", this.parseJSON("isaaclab.json"), collapsed));
        this.items.push(this.buildSubtree("Developer", this.parseJSON("developer.json"), collapsed));
        this.items.push(this.buildSubtree("Omniverse", this.parseJSON("omniverse.json"), collapsed));
    }
    getTreeItem(element) {
        return element;
    }
