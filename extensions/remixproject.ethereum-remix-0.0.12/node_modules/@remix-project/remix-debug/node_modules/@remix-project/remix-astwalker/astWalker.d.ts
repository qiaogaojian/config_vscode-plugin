...
export declare class AstWalker extends EventEmitter {
    manageCallback(node: AstNodeLegacy | AstNode, callback: Record<string, unknown> | Function): any;
    walk(ast: AstNodeLegacy | AstNode, callback?: Function | Record<string, unknown>): void;
