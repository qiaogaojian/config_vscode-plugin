...
class StringType extends DynamicByteArray_1.DynamicByteArray {
    ...
    decodeFromStack(stackDepth, stack, memory, calldata, variableDetails) {
        const _super = Object.create(null, {
            decodeFromStack: { get: () => super.decodeFromStack }
        });
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                return yield _super.decodeFromStack.call(this, stackDepth, stack, memory, null, calldata, variableDetails);
            }
            catch (e) {
                console.log(e);
                return '<decoding failed - ' + e.message + '>';
