...
function getChecksumAddress(address) {
    ...
    const hashed = bytes_1.arrayify(keccak256_1.keccak256(expanded));
...
function getIcapAddress(address) {
    let base36 = bignumber_1._base16To36(getAddress(address).substring(2)).toUpperCase();
...
function getContractAddress(transaction) {
    ...
    const nonce = bytes_1.stripZeros(bytes_1.arrayify(bignumber_1.BigNumber.from(transaction.nonce).toHexString()));
