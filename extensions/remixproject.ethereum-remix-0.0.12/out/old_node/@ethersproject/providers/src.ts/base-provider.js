...
class Resolver {
    ...
    _fetchBytes(selector, parameters) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const offset = bignumber_1.BigNumber.from(bytes_1.hexDataSlice(result, 0, 32)).toNumber();
            const length = bignumber_1.BigNumber.from(bytes_1.hexDataSlice(result, offset, offset + 32)).toNumber();
            return bytes_1.hexDataSlice(result, offset + 32, offset + 32 + length);
        });
    }
    _getAddress(coinType, hexBytes) {
        ...
        const bytes = bytes_1.arrayify(hexBytes);
    ...
    getAddress(coinType) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (coinType === 60) {
                ...
                // No address
                if (hexBytes === "0x" || hexBytes === constants_1.HashZero) {
                    return null;
                }
    ...
    getText(key) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let keyBytes = strings_1.toUtf8Bytes(key);
            ...
            const hexBytes = yield this._fetchBytes("0x59d1d43c", bytes_1.hexlify(keyBytes));
            if (hexBytes == null || hexBytes === "0x") {
                return null;
            }
            return strings_1.toUtf8String(hexBytes);
        });
    }
}
...
class BaseProvider extends abstract_provider_1.Provider {
    ...
    getBalance(addressOrName, blockTag) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.getNetwork();
            const params = yield properties_1.resolveProperties({
    ...
    getStorageAt(addressOrName, position, blockTag) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const params = yield properties_1.resolveProperties({
                address: this._getAddress(addressOrName),
                blockTag: this._getBlockTag(blockTag),
                position: Promise.resolve(position).then((p) => bytes_1.hexValue(p))
            });
    ...
    sendTransaction(signedTransaction) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.getNetwork();
            const hexTx = yield Promise.resolve(signedTransaction).then(t => bytes_1.hexlify(t));
    ...
    _getTransactionRequest(transaction) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.formatter.transactionRequest(yield properties_1.resolveProperties(tx));
        });
    }
    _getFilter(filter) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.formatter.filter(yield properties_1.resolveProperties(result));
        });
    }
    ...
    _getBlock(blockHashOrBlockTag, includeTransactions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return web_1.poll(() => __awaiter(this, void 0, void 0, function* () {
    ...
    getLogs(filter) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.getNetwork();
            const params = yield properties_1.resolveProperties({ filter: this._getFilter(filter) });
    ...
    lookupAddress(address) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // keccak("name(bytes32)")
            let bytes = bytes_1.arrayify(yield this.call({
                to: resolverAddress,
