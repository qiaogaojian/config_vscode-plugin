...
function getTransactionPostData(transaction) {
    ...
    for (let key in transaction) {
        ...
        if ({ type: true, gasLimit: true, gasPrice: true, nonce: true, value: true }[key]) {
            ...
            value = "[" + transactions_1.accessListify(value).map((set) => {
...
class EtherscanProvider extends base_provider_1.BaseProvider {
    constructor(network, apiKey) {
        ...
        super(network);
        properties_1.defineReadOnly(this, "baseUrl", this.getBaseUrl());
        properties_1.defineReadOnly(this, "apiKey", apiKey || defaultApiKey);
    }
    getBaseUrl() {
    ...
    fetch(module, params, post) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield web_1.fetchJson(connection, payloadStr, procFunc || getJsonResult);
            this.emit("debug", {
                action: "response",
                request: url,
