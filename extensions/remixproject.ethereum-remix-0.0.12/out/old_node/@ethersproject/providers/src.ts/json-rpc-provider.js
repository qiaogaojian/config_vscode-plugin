...
class JsonRpcSigner extends abstract_signer_1.Signer {
    constructor(constructorGuard, provider, addressOrIndex) {
        ...
        if (typeof (addressOrIndex) === "string") {
            properties_1.defineReadOnly(this, "_address", this.provider.formatter.address(addressOrIndex));
            properties_1.defineReadOnly(this, "_index", null);
        }
        else if (typeof (addressOrIndex) === "number") {
            properties_1.defineReadOnly(this, "_index", addressOrIndex);
            properties_1.defineReadOnly(this, "_address", null);
        }
        else {
    ...
    sendUncheckedTransaction(transaction) {
        ...
        if (transaction.gasLimit == null) {
            const estimate = properties_1.shallowCopy(transaction);
    ...
    sendTransaction(transaction) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                return yield web_1.poll(() => __awaiter(this, void 0, void 0, function* () {
    ...
    signMessage(message) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.provider.send("eth_sign", [address.toLowerCase(), bytes_1.hexlify(data)]);
        });
    }
...
class JsonRpcProvider extends base_provider_1.BaseProvider {
    constructor(url, network) {
        ...
        // Default URL
        if (!url) {
            url = properties_1.getStatic(this.constructor, "defaultUrl")();
        }
        if (typeof (url) === "string") {
            properties_1.defineReadOnly(this, "connection", Object.freeze({
                url: url
            }));
        }
        else {
            properties_1.defineReadOnly(this, "connection", Object.freeze(properties_1.shallowCopy(url)));
        }
        this._nextId = 42;
    }
    get _cache() {
    ...
    send(method, params) {
        ...
        const result = web_1.fetchJson(this.connection, JSON.stringify(request), getResult).then((result) => {
            this.emit("debug", {
                action: "response",
                request: request,
                response: result,
    ...
    prepareRequest(method, params) {
        switch (method) {
            ...
            case "call": {
                const hexlifyTransaction = properties_1.getStatic(this.constructor, "hexlifyTransaction");
    ...
    static hexlifyTransaction(transaction, allowExtra) {
        ...
        const allowed = properties_1.shallowCopy(allowedTransactionKeys);
        if (allowExtra) {
        ...
        ["gasLimit", "gasPrice", "type", "nonce", "value"].forEach(function (key) {
            ...
            const value = bytes_1.hexValue(transaction[key]);
            if (key === "gasLimit") {
                key = "gas";
            }
            result[key] = value;
