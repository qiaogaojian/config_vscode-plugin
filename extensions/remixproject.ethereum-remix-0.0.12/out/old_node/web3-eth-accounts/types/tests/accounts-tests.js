...
// $ExpectType Accounts
const accounts_empty = new web3_eth_accounts_1.Accounts();
// $ExpectType Accounts
const accounts = new web3_eth_accounts_1.Accounts('http://localhost:8545');
// $ExpectType provider
...
// $ExpectType Account
accounts.privateKeyToAccount('0x348ce564d427a3311b6536bbcff9390d69395b06ed6c486954e971d960fe8709', true);
...
accounts.signTransaction({
    ...
    value: '1000000000',
    gas: 2000000
}, '0x4c0883a69102937d6231471b5dbb6204fe5129617082792ae468d01a3f362318', (error, signedTransaction) => {
    console.log('hey');
});
// $ExpectType string
